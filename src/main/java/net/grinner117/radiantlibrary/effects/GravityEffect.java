...
public class GravityEffect extends MobEffect {
	...
	public static void entityTick(TickEvent.PlayerTickEvent e) {
		if (e.phase == TickEvent.Phase.END && e.player.hasEffect(ModEffects.GRAVITY_EFFECT.get()) && !e.player.isOnGround() && !e.player.isCreative()) {
	...
	public static void entityHurt(LivingHurtEvent e) {
		if (e.getSource().equals(DamageSource.FALL) && e.getEntity().hasEffect(ModEffects.GRAVITY_EFFECT.get())) {
