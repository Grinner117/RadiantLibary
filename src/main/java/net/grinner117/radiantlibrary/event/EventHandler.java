...
//		if (e.getEntity() != null && e.getSource() == DamageSource.LIGHTNING_BOLT && e.getEntity().hasEffect(ModEffects.LIGHTNING_EFFECT.get())) {
//			float damage = e.getAmount() + 3.0f + 3.0f * e.getEntity().getEffect(ModEffects.LIGHTNING_EFFECT.get()).getAmplifier();
//			e.setAmount(Math.max(0, damage));
//		}
		LivingEntity entity = e.getEntity();
		if (entity != null && entity.hasEffect(ModEffects.NULLCURSE_EFFECT.get()) &&
				(entity.hasEffect(MobEffects.POISON) || entity.hasEffect(MobEffects.WITHER) || entity.isOnFire()
//						|| entity.hasEffect(ModEffects.LIGHTNING_EFFECT.get())
				)) {
